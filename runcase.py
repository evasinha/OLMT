...
if (options.mod_parm_file != ''):
    ...
    myncap = 'ncap'
    if ('anvil' in options.machine or 'compy' in options.machine or 'ubuntu' in options.machine \
...
if ((options.ensemble_file != '' or int(options.mc_ensemble) != -1) and (options.constraints == '' or (
    ...
    mysubmit_type = 'qsub'
    if ('anvil' in options.machine or 'cades' in options.machine or 'compy' in options.machine or 'ubuntu' in options.machine or 'cori' in options.machine or options.machine == 'edison'):
